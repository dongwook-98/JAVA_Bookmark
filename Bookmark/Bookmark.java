...
public class Bookmark {
    ...
    public Bookmark(String name, String url, String groupName, String memo){
        this.name = name;
        this.url = url;
    ...
    public Bookmark(String name, String addedTime, String url, String groupName, String memo){
